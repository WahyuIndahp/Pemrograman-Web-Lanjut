...
<div>
    <center> 
        <h1 class="display-4">Welcome To Genre Romance</h1>
    </center>
</div>
@endsection
@section('content')
<div class="container">
    <div class="row">
            ...
            <div class="col-md-8">
                <a href="{{route('romance.artikel',$all->id_kategori)}}">
                    </a>
                    @if($all->id_kategori=='1')
                    <div class="Judul">
                        <h2>{{$all->judul}}</h2>
                        <img class="img-responsive" src="{{asset('/img/romance.jpg')}}" alt="">
                        <h3>Info Drama :
